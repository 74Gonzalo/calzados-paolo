...
<head>
    ...
    <title>Calzados Paolo</title>
</head>
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
<section class="container">

  <header>
            <a href="index.php"><h1>Calzados Paolo</h1></a>

        <p>Tus zapatos, en Hurlingham</p>
        <nav>
          <ul>
...
<div class="visor">
      <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:600px;height:500px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:600px;height:500px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/zapato1.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato2.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato3.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato6.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato4.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato5.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/zapato7.jpg" />
            </div>
        </div>
        <!-- Bullet Navigator -->
